...
export class PersonaRolService {
  ...
  getAll(): Observable<PersonaRol[] | null> {
    ...
    return this.http.get<PersonaRol[]>(url).pipe(catchError(this.handleError));
  }
  ...
  add(datos: any): Observable<PersonaRol | null> {
    return this.http
      .post<PersonaRol>(ServiciosTsr.RS_PRRL, datos, this.httpOptions)
  ...
  update(datos: any): Observable<PersonaRol | null> {
    return this.http
      .put<PersonaRol>(ServiciosTsr.RS_PRRL, datos, this.httpOptions)
      .pipe(catchError(this.handleError));
  }
  ...
  delete(id: any): Observable<PersonaRol | null> {
    ...
    return this.http.delete<PersonaRol>(url, this.httpOptions).pipe(catchError(this.handleError));
  }
