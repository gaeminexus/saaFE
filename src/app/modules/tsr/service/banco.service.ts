...
export class BancoService {
  ...
  getAll(): Observable<Banco[] | null> {
    ...
    return this.http.get<Banco[]>(url).pipe(catchError(this.handleError));
  }
  ...
  add(datos: any): Observable<Banco | null> {
    return this.http
      .post<Banco>(ServiciosTsr.RS_BNCO, datos, this.httpOptions)
  ...
  update(datos: any): Observable<Banco | null> {
    return this.http
      .put<Banco>(ServiciosTsr.RS_BNCO, datos, this.httpOptions)
      .pipe(catchError(this.handleError));
  }
  ...
  delete(id: any): Observable<Banco | null> {
    ...
    return this.http.delete<Banco>(url, this.httpOptions).pipe(catchError(this.handleError));
  }
