...
export class TurnoService {
 ...
 httpOptions = {
  ...
  add(datos: any): Observable<Turno | null> {
    return this.http.post<Turno>(ServiciosRhh.RS_TRNO, datos, this.httpOptions).pipe(
      catchError(this.handleError)
    );
  }
  ...
  update(datos: any): Observable<Turno | null> {
    return this.http.put<Turno>(ServiciosRhh.RS_TRNO, datos, this.httpOptions).pipe(
      catchError(this.handleError)
    );
  }
