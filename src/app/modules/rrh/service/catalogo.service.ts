...
export class CatalogoService {
  ...
  add(datos: any): Observable<Catalogo | null> {
    return this.http.post<Catalogo>(ServiciosRhh.RS_CTLG, datos, this.httpOptions).pipe(
      catchError(this.handleError)
    );
  }
  ...
  update(datos: any): Observable<Catalogo | null> {
    return this.http.put<Catalogo>(ServiciosRhh.RS_CTLG, datos, this.httpOptions).pipe(
      catchError(this.handleError)
    );
  }
  ...
  delete(id: any): Observable<Catalogo | null> {
    const wsEndpoint = '/' + id;
    const url = `${ServiciosRhh.RS_CTLG}${wsEndpoint}`;
    return this.http.delete<Catalogo>(url, this.httpOptions).pipe(
      catchError(this.handleError)
    );
  }
