...
export class ContratoEmpleadoService {
  ...
  getAll(): Observable<ContratoEmpleado[] | null> {
    ...
    return this.http.get<ContratoEmpleado[]>(url).pipe(
  ...
  add(datos: any): Observable<ContratoEmpleado | null> {
    return this.http.post<ContratoEmpleado>(ServiciosRhh.RS_CNTR, datos, this.httpOptions).pipe(
      catchError(this.handleError)
    );
  }
  ...
  update(datos: any): Observable<ContratoEmpleado | null> {
    return this.http.put<ContratoEmpleado>(ServiciosRhh.RS_CNTR, datos, this.httpOptions).pipe(
      catchError(this.handleError)
    );
  }
  ...
  delete(id: any): Observable<ContratoEmpleado | null> {
    const wsEndpoint = '/' + id;
    const url = `${ServiciosRhh.RS_CNTR}${wsEndpoint}`;
    return this.http.delete<ContratoEmpleado>(url, this.httpOptions).pipe(
      catchError(this.handleError)
    );
  }
