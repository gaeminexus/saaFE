...
export class DepartementoCargoService {
  ...
  getAll(): Observable<departamentocargo[] | null> {
    ...
    return this.http.get<departamentocargo[]>(url).pipe(
  ...
  add(datos: any): Observable<departamentocargo | null> {
    return this.http.post<departamentocargo>(ServiciosRhh.RS_DPRT, datos, this.httpOptions).pipe(
      catchError(this.handleError)
    );
  }
  ...
  update(datos: any): Observable<departamentocargo | null> {
    return this.http.put<departamentocargo>(ServiciosRhh.RS_DPRT, datos, this.httpOptions).pipe(
      catchError(this.handleError)
    );
  }
  ...
  delete(id: any): Observable<departamentocargo | null> {
    const wsEndpoint = '/' + id;
    const url = `${ServiciosRhh.RS_DPRT}${wsEndpoint}`;
    return this.http.delete<departamentocargo>(url, this.httpOptions).pipe(
      catchError(this.handleError)
    );
  }
