...
export class ContratoService {
  ...
  getAll(): Observable<Contrato[] | null> {
    ...
    return this.http.get<Contrato[]>(url).pipe(catchError(this.handleError));
  }
  ...
  add(datos: any): Observable<Contrato | null> {
    return this.http
      .post<Contrato>(ServiciosRhh.RS_CNTR, datos, this.httpOptions)
  ...
  update(datos: any): Observable<Contrato | null> {
    return this.http
      .put<Contrato>(ServiciosRhh.RS_CNTR, datos, this.httpOptions)
      .pipe(catchError(this.handleError));
  }
  ...
  delete(id: any): Observable<Contrato | null> {
    const wsEndpoint = '/' + id;
    const url = `${ServiciosRhh.RS_CNTR}${wsEndpoint}`;
    return this.http.delete<Contrato>(url, this.httpOptions).pipe(catchError(this.handleError));
  }
