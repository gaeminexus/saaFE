  ...
  return [
...

    {
      ...
      campos: [
        ...
        { name: 'numeroCuenta', label: 'Número de cuenta', tipo: 'texto', requerido: true, grupo: 'Cuenta' },
        { name: 'titular', label: 'Titular (si difiere)', tipo: 'texto', grupo: 'Titular alterno' },
        { name: 'identificacionTitular', label: 'Identificación del titular', tipo: 'texto', grupo: 'Titular alterno' },
        { ...bandera('principal', 'Es la cuenta principal', 'S'), grupo: 'Reparto y estado' },
        { name: 'porcentaje', label: '% del neto a acreditar', tipo: 'numero', grupo: 'Reparto y estado' },
        { ...campoEstado, grupo: 'Reparto y estado' },
      ],
      permiteBorrar: true,
