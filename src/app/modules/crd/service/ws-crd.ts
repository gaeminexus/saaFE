...
export class ServiciosCrd {
  ...
  // Contrato cerrado (BE 3e89bb6, 2026-09-07): docs/logica-negocio/crd/API-CALIFICACION-RIESGO.md
  public static RS_CFCR = `${API_URL}/cfcr`; // ConfiguracionCalificacionRiesgo — único endpoint de escritura
  public static RS_ESCR = `${API_URL}/escr`; // EscalaCalificacionRiesgo — SOLO LECTURA (§0bis del contrato)
