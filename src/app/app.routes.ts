...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'procesos/planilla-control-iess',
        loadComponent: () =>
          import(
            './modules/rrh/forms/procesos/planilla-control-iess/planilla-control-iess.component'
          ).then((m) => m.PlanillaControlIessComponent),
        canActivate: [authGuard],
